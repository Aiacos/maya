...
if isMaya:
    ...
    from zoo.libs.maya.utils import tooltips, mayaenv
...
class SpawnerIcon(iconmenu.IconMenuButton):
    ...
    def __init__(self, zooWindow, showDockTabs=True, parent=None):
    ...
    def name(self):
        ...
        """
        return (
            self.zooWindow.title
            or self.zooWindow.name
    ...
    @staticmethod
    def _updateZooLayoutDirection(horizontal):
    ...
    def initDockingContainer(self):
        ...
        kwargs = dict(
            ...
            vis=True,
            requiredPlugin="zooTools",
        )
        if mayaenv.mayaVersion() > 2022:
            kwargs["actLikeMayaUIElement"] = not self._showDockTabs
            kwargs["layoutDirectionCallback"] = "_updateZooLayoutDirection"
