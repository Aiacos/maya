...
class ObjectsToolbox(toolsetwidget.ToolsetWidget):
    ...
    def uiConnections(self):
        ...
        self.advancedWidget.duplicateBtn.createMenuItem(text="Duplicate Selected Only (Default)",
                                                        icon=iconlib.icon("duplicateMaya"),
                                                        connection=self.duplicateMel)
        self.advancedWidget.duplicateBtn.createMenuItem(text="Duplicate & Input Connected Node Graph",
                                                        icon=iconlib.icon("duplicateMaya"),
                                                        connection=self.duplicateInputGraphMel)
        self.advancedWidget.duplicateBtn.createMenuItem(text="Duplicate Share Input Connections",
                                                        icon=iconlib.icon("duplicateMaya"),
                                                        connection=self.duplicateInputConnectionsMel)
        self.advancedWidget.duplicateBtn.createMenuItem(text="Duplicate Face Selection",
                                                        icon=iconlib.icon("duplicateMaya"),
                                                        connection=self.duplicateFaceMel)
        self.advancedWidget.duplicateBtn.createMenuItem(text="Open Duplicate Options",
