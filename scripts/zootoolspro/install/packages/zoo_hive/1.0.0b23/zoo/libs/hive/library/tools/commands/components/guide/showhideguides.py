...
class ToggleRigGuideShapeVisibilityCommand(command.ZooCommandMaya):
    ...
    uiData = {"icon": "",
              "tooltip": __doc__,
              "label": "Toggle Guide Shape Visibility For Rig",
              "color": "",
              "backgroundColor": ""
              }
    _rig = None
...
class ToggleRigGuideVisibilityCommand(command.ZooCommandMaya):
    ...
    uiData = {"icon": "",
              "tooltip": __doc__,
              "label": "Toggle Guide Visibility For Rig",
              "color": "",
              "backgroundColor": ""
              }
    _rig = None
...
class SetComponentLRACommand(command.ZooCommandMaya):
    ...
    uiData = {"icon": "",
              "tooltip": __doc__,
              "label": "Set Component Guides' LRA",
              "color": "",
              "backgroundColor": ""
              }
    _components = []
...
class ToggleGuideVisibilityFromSelectedCommand(command.ZooCommandMaya):
    ...
    uiData = {"icon": "",
              "tooltip": __doc__,
              "label": "Toggle Guide Visibility(selection)",
              "color": "",
              "backgroundColor": ""
              }
    _components = []
