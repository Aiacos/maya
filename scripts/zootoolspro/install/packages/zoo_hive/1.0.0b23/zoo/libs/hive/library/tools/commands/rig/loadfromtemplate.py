...
class LoadFromTemplate(command.ZooCommandMaya):
    ...
    uiData = {"icon": "",
              "tooltip": "Loads a hive template, if a rig is present then the components will be added",
...
class SaveTemplate(command.ZooCommandMaya):
    ...
    _rig = None
    uiData = {"icon": "",
              "tooltip": "Save Rig as a template into the main hive Library",
...
class DeleteTemplate(command.ZooCommandMaya):
    ...
    _rig = None
    uiData = {"icon": "",
              "tooltip": "Deletes Rig from the hive Library",
