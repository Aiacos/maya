...
class InstallerCore(object):
    ...
    def loadZooPlugin(self, rootDirectory):
        ...
        zooUndo = os.path.join(extensionsFolder, "maya", "plug-ins", "zooundo.py")
        ...
        logger.debug("Setting autoload for'zooundo.py'")
        cmds.pluginInfo("zooundo.py", autoload=1, e=1)
        cmds.pluginInfo("zooundo.py", savePluginPrefs=1)
