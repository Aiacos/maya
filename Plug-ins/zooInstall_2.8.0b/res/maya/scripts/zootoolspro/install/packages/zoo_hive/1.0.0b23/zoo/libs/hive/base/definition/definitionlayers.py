...
class GuideLayerDefinition(LayerDef):
    ...
    def fromData(cls, layerData):
        ...
        data = {constants.DAG_DEF_KEY: [definitionnodes.GuideDefinition.deserialize(guideData) for guideData in
    ...
    def update(self, kwargs):
        ...
        for ioNode in defutils.traverseDefinitionLayerDag(kwargs):
            ...
            if currentNode is not None:
                ...
                # convert the incomming children to definition instances before updating
                children = ioNode.get("children")
                if children:
                    ioNode["children"] = [definitionnodes.GuideDefinition.deserialize(i, ioNode["id"]) for i in
                                          children]
