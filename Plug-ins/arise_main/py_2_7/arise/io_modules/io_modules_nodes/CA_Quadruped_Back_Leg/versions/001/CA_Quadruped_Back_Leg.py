"""Cartoon_A_Quadruped_Back module creates a cartoon_complex quadruped back leg module. """
...
TOOL_TIP = "Cartoon quadruped back leg with IK/FK, ribbons, twist, soft IK, stretch, pin ctrl and more."
...
class CA_Quadruped_Back_Leg(node_data.NodeData):
    ...
    def attributes_creation(self):
        ...
        self.auto_clavicle_attr = self.add_boolean_attribute(
            ...
            annotation=(
                ...
                "Turned off by default for hind legs."
            )
        )
        self.close_layout()
    ...
    def guides_creation(self):
        ...
        self.base_guide = self.add_guide(name="base", translation=[5.52, 126, -35.6], rotation=[0, 0, 180])
        self.base_guide.size = self.base_guide.size * 1.8

        self.root_guide = self.add_aim_guide(name="root", translation=[14.5, 116, -51], parent=self.base_guide)
        self.mid_guide = self.add_aim_guide(name="mid", translation=[16.5, 75.9, -47], parent=self.base_guide)
        self.mid_guide.visual_parent = self.root_guide

        self.tip_guide = self.add_guide(
            name="tip",
            translation=[13.6, 47.5, -64.2],
            rotation=[0, 0, 180],
