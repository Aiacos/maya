...
from arise.external_modules.grandalf.utils import Poset
...
class Graph(graph_core):
    ...
    def __init__(self, V=None, E=None, directed=True):
        graph_core.__init__(self, V=V, E=E, directed=directed)
        self._v_list = None
        self._e_list = None
        self.C = []
