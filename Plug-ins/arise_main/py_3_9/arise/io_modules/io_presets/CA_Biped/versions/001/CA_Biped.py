...
TAGS = ["male", "female", "human", "character"]  # (for filtering modules in lists).
TOOL_TIP = "Cartoon biped preset."  # short explanation on module.


class CA_Biped(preset_data.PresetData):
