...
TAGS = ["chassis", "vehicle", "car", "truck", "steering", "automobile", "motorcar", "van", "minivan",]
TOOL_TIP = "A car preset that can easily be converted to a truck, van, or any other type of vehicle."


class Car(preset_data.PresetData):
