""" Preset of cartoon_a modules building a biped character. """
...
TAGS = ["male", "female", "human", "character", "face", "eyes", "mouth"]  # (for filtering modules in lists).
TOOL_TIP = "Cartoon biped preset with face nodes."  # short explanation on module.


class CA_Biped_With_Face(preset_data.PresetData):
