""" Preset of cartoon_a modules building a quad character. """
...
TAGS = ["dog", "wolf", "Quad", "character", "horse", "cat", "digitigrades"]  # (for filtering modules in lists).
TOOL_TIP = "Cartoon quadruped (4 legs) preset."  # short explanation on module.


class CA_Quadruped(preset_data.PresetData):
