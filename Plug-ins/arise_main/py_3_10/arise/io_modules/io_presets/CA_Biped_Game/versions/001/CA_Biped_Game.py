...
TAGS = ["male", "female", "human", "character", "game", "engine", "single chain"]
TOOL_TIP = "Game Engine Ready Cartoon Biped Preset with FollowSkeleton Setup"


class CA_Biped_Game(preset_data.PresetData):
