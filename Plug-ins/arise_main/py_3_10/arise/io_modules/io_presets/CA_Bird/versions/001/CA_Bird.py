""" Preset of cartoon_a modules building a bird character. """
...
RIG_TYPE = "Bird"  # Biped, Car, Quadruped, All, ... (for filtering modules in lists).
TAGS = ["wing", "feathers", "avifauna", "character", "flight",]
TOOL_TIP = "Cartoon bird preset."  # short explanation on module.


class CA_Bird(preset_data.PresetData):
