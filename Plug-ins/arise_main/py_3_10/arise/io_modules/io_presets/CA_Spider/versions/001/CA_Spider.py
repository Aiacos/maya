""" Preset of cartoon_a modules building a spider character. """
...
RIG_TYPE = "Arachnid"  # Biped, Car, Quadruped, All, ... (for filtering modules in lists).
TAGS = ["spider", "bug", "Quad", "character", "Arachnid", "legs", "exoskeleton", "arthropods",]
TOOL_TIP = "Cartoon spider preset."  # short explanation on module.


class CA_Spider(preset_data.PresetData):
