""" Preset of cartoon_a modules building a octopus character. """
...
TAGS = ["tentacle", "squid", "ribbon", "cuttlefish", "nautiloid", "limbs", "sea", ]
TOOL_TIP = "Cartoon octopus preset."  # short explanation on module.


class CA_Octopus(preset_data.PresetData):
