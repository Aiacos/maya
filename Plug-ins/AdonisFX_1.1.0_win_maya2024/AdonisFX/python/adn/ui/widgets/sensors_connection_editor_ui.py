...
class SensorsConnectionEditorUI(BaseWidget):
    ...
    def _reload_left_on_clicked(self):
        ...
        source_nodes, short_source_names = self._dcc_tool.collect_connection_info_source_nodes()
        if source_nodes:
            self._clear_sources_column()
    ...
    def _reload_right_on_clicked(self):
        ...
        nodes, short_destination_nodes = self._dcc_tool.collect_destination_nodes_plugs()
        if nodes:
            self._clear_destination_column()
    ...
    def _connect_on_clicked(self):
        ...
        # Connect attribute
        self._dcc_tool.connect_sensor_output(source_selected, attribute_node_selected)
