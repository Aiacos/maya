...
from zoo.apps.hiveartistui.views import validationview
...
class HiveRigFbxExportToolset(toolsetwidget.ToolsetWidget):
    ...
    def setUiSettings(self, uiSettingsDict):
        ...
        self.compactWidget.tangentsCheckBox.setEnabled(skinState)
        self.compactWidget.smoothingGroups.setEnabled(skinState)
