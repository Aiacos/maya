...
from zoo.libs.maya.cmds.renderer import arnoldrendersettings
...
class RenderObjectDisplay(toolsetwidget.ToolsetWidget):
    ...
    def arnoldVisibility(self):
        """Sets Arnold Visibility """
        arnoldrendersettings.setArnoldVisibilitySel(visibility=self.properties.arnoldVisibilityCheckbox.value)

    def arnoldMatteObject(self):
        """Sets Arnold Matte Object """
        arnoldrendersettings.setArnoldMatteSel(matte=self.properties.arnoldMatteCheckbox.value)
    ...
    def uiConnections(self):
        ...
        for widget in self.widgets():
            ...
            # Arnold
            widget.arnoldVisibilityCheckbox.stateChanged.connect(self.arnoldVisibility)
            widget.arnoldMatteCheckbox.stateChanged.connect(self.arnoldMatteObject)
...
class GuiWidgets(QtWidgets.QWidget):
    def __init__(self, parent=None, properties=None, uiMode=None, toolsetWidget=None):
        ...
        # ARNOlD ---------------------------------------
        # Vis ---------------------------------------
        tooltip = "Sets Arnold object render settings to be visible in renders."
        self.arnoldVisibilityCheckbox = elements.CheckBox(label="Arnold Visibility",
                                                          checked=True,
                                                          toolTip=tooltip)
        # Matte ---------------------------------------
        tooltip = "Sets Arnold object render settings to be matte."
        self.arnoldMatteCheckbox = elements.CheckBox(label="Arnold Matte",
                                                          checked=True,
                                                          toolTip=tooltip)
...
class GuiCompact(GuiWidgets):
    def __init__(self, parent=None, properties=None, uiMode=UI_MODE_COMPACT, toolsetWidget=None):
        ...
        # Arnold ---------------------------------------
        arnoldLayout = elements.GridLayout(spacing=uic.SVLRG,
                                           margins=(uic.REGPAD, uic.REGPAD, uic.REGPAD, uic.REGPAD,))
        row = 0
        arnoldLayout.addWidget(self.arnoldVisibilityCheckbox, row, 0)
        arnoldLayout.addWidget(self.arnoldMatteCheckbox, row, 1)
        gridTopLayout.setColumnStretch(0, 1)
        gridTopLayout.setColumnStretch(1, 1)

        # Add To Main Layout ---------------------------------------
        mainLayout.addLayout(gridTopLayout)
        mainLayout.addWidget(elements.LabelDivider("Arnold", parent=self))
        mainLayout.addLayout(arnoldLayout)
