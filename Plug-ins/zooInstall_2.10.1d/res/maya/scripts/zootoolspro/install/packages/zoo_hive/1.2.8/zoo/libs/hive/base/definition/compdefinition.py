...
from zoo.libs.hive.base.definition import spaceswitch, driverutils
...
class ComponentDefinition(object):
    ...
    def toTemplate(self):
        ...
        raw.setdefault(constants.DEFORMLAYER_DEF_KEY, {})[constants.METADATA_DEF_KEY] = data.get(constants.METADATA_DEF_KEY, [])
