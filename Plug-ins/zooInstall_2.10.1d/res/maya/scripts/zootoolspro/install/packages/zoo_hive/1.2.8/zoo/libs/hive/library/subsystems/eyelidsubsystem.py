                                        ...
                                        float $quatMultiplier)
{
    ...
    float $fleshyUpDownRemap = zooRemap($fleshUpDown, 0.0, 10.0, 0.0, 10.0);
                                    ...
                                    )
{
    ...
    float $fleshyLRRemap = zooRemap($fleshLR, 0.0, 10.0, 0.0, 10.0);
...
"""
_LID_MEL_EXPR = """
float {primaryCtrlTranslateVar}Y = zooRemap({lidPrimaryCtrlY}, 0.0, {primaryCtrlCloseLidValue}, 0.0, 1.0);
